+++
title = "GO-WEB编程-1.GO环境配置-1.4GO开发工具"
date = "2021-03-10T11:05:00+08:00"
tags = ["GO", "WEB"]
slug = "go-ide"
indent = false
+++
...
## Sublime Text
  ...
  - 自动化提示代码,如下图所示
	...
	![](https://github.com/worldofrorrim/build-web-application-with-golang/raw/master/zh/images/1.4.sublime1.png?raw=true)
  ...
  - 支持项目管理
	...
	![](https://github.com/worldofrorrim/build-web-application-with-golang/raw/master/zh/images/1.4.sublime2.png?raw=true)
...
```
  ...
  ![](https://github.com/worldofrorrim/build-web-application-with-golang/raw/master/zh/images/1.4.sublime3.png?raw=true)
  ...
  ![](https://github.com/worldofrorrim/build-web-application-with-golang/raw/master/zh/images/1.4.sublime4.png?raw=true)
...
## LiteIDE
  ...
  ![](https://github.com/worldofrorrim/build-web-application-with-golang/raw/master/zh/images/1.4.liteide.png?raw=true)
...
![](https://github.com/worldofrorrim/build-web-application-with-golang/raw/master/zh/images/1.4.vim.png?raw=true)
...
Emacs传说中的神器，她不仅仅是一个编辑器，它是一个整合环境，或可称它为集成开发环境，这些功能如让使用者置身于全功能的操作系统中。
  ...
  ![](https://github.com/worldofrorrim/build-web-application-with-golang/raw/master/zh/images/1.4.emacs.png?raw=true)
...
Eclipse也是非常常用的开发利器，以下介绍如何使用Eclipse来编写Go程序。
  ...
  ![](https://github.com/worldofrorrim/build-web-application-with-golang/raw/master/zh/images/1.4.eclipse1.png?raw=true)
...
5. 配置插件
  ...
  ![](https://github.com/worldofrorrim/build-web-application-with-golang/raw/master/zh/images/1.4.eclipse2.png?raw=true)
  ...
  ![](https://github.com/worldofrorrim/build-web-application-with-golang/raw/master/zh/images/1.4.eclipse3.png?raw=true)

  图1.13 设置gocode信息

  (3).配置GDB（可选，做调试用），设置GDB路径为MingW安装目录下的gdb.exe文件

  ![](https://github.com/worldofrorrim/build-web-application-with-golang/raw/master/zh/images/1.4.eclipse4.png?raw=true)
...
6. 测试是否成功
	...
	新建一个go工程，再建立一个hello.go。如下图：
	  ...
	  ![](https://github.com/worldofrorrim/build-web-application-with-golang/raw/master/zh/images/1.4.eclipse5.png?raw=true)

	  图1.15 新建项目编辑文件

	调试如下（要在console中用输入命令来调试）：

	  ![](https://github.com/worldofrorrim/build-web-application-with-golang/raw/master/zh/images/1.4.eclipse6.png?raw=true)
...
1. 先下载idea，idea支持多平台：win,mac,linux，如果有钱就买个正式版，如果不行就使用社区免费版，对于只是开发Go语言来说免费版足够用了
	...
	![](https://github.com/worldofrorrim/build-web-application-with-golang/raw/master/zh/images/1.4.idea1.png?raw=true)

2. 安装Go插件，点击菜单File中的Setting，找到Plugins,点击,Broswer repo按钮。国内的用户可能会报错，自己解决哈。

	![](https://github.com/worldofrorrim/build-web-application-with-golang/raw/master/zh/images/1.4.idea3.png?raw=true)

3. 这时候会看见很多插件，搜索找到Golang,双击,download and install。等到golang那一行后面出现Downloaded标志后,点OK。

	![](https://github.com/worldofrorrim/build-web-application-with-golang/raw/master/zh/images/1.4.idea4.png?raw=true)

	然后点 Apply .这时候IDE会要求你重启。

4. 	重启完毕后,创建新项目会发现已经可以创建golang项目了：

	![](https://github.com/worldofrorrim/build-web-application-with-golang/raw/master/zh/images/1.4.idea5.png?raw=true)
